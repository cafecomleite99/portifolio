    ...
    return ( 
        <ProfileWrapper>
            <div className='profile-photo'> 
                <img src={leonardo} alt="Leonardo Sousa" />
            </div>
